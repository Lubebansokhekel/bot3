//base by DGNeraka (Neraka Bot Inc.)
//re-upload? recode? copy code? give credit ya :)
//YouTube: @DGNeraka
//Instagram: unicorn_xeon13
//Telegram: t.me/Nerakaz
//GitHub: @DGNeraka
//WhatsApp: +60177480773
//want more free bot scripts? subscribe to my youtube channel: https://youtube.com/@DGNeraka
 ...
 * @param {Object} _dir
 */
const expiredCheck = (Nerakaz, msg, _dir) => {
	setInterval(() => {
		let position = null;
		Object.keys(_dir).forEach((i) => {
		...
		if (position !== null) {
			...
			fs.writeFileSync("./database/premium.json", JSON.stringify(_dir));
			idny ? Nerakaz.sendMessage(idny, { text: "Your premium has run out, please buy again." }) : "";
			idny = false;
		}
	}, 1000);
};
