...
function _parseVideoInitialData(responseText, callback) {
  ...
  var author_name = _jp.value(idata, '$..bigboss..title..text') || _jp.value(idata, '$..bigboss..title..simpleText');

  var author_url = _jp.value(idata, '$..bigboss..navigationEndpoint..url') || _jp.value(idata, '$..bigboss..title..url');
...
function _parsePlaylistInitialData(responseText, callback) {
  ...
  var playlist = {
    ...
    alertInfo: alertInfo,
    author: {
      name: _jp.value(json, '$..videoBigboss..title..runs[0]..text'),
      url: 'https://youtube.com' + _jp.value(json, '$..videoBigboss..navigationEndpoint..url')
    }
  };
